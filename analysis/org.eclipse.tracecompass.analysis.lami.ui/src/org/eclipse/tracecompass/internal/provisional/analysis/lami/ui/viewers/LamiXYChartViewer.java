...
public abstract class LamiXYChartViewer extends TmfViewer implements ILamiViewer {
    ...
    /**
     * Util method that will return a formatter based on the aspects linked to
     * an axis
     *
     * If all aspects are time stamps, return a timestamp formatter tuned to the
     * interval. If all aspects are time durations, return the nanoseconds to
     * seconds formatter. Otherwise, return the generic decimal formatter.
     *
     * @param axisAspects
